...
{
    static FILE* EnumName = fopen("/storage/emulated/0/dumptool/Enum.cpp", "w+");
	string Type = "uint8_t";
...
{
    static FILE* UClass = fopen("/storage/emulated/0/dumptool/Class.cpp", "w+");
...
{
    static FILE* Function = fopen("/storage/emulated/0/dumptool/Function.cpp", "w+");
...
{
    static FILE* Struct = fopen("/storage/emulated/0/dumptool/Struct.cpp", "w+");
	char buf[64]{ 0 };
